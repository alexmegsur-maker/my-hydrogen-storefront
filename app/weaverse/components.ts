...
import * as ProductATCButtons from "~/sections/main-product/buy-buttons";
...
import * as VideoColumnText from "~/components/video-column-text";
import * as HeaderEdit from "~/sections/header-edit"
import * as HeaderEditText from "~/sections/header-edit/text"
import * as HeaderEditTextTop from "~/sections/header-edit/top-text"
import * as HeaderEditGeneral from "~/sections/header-edit/general"
import * as HeaderBanner from "~/sections/header-edit/banner"
import * as ImageLinkBanner from "~/sections/header-edit/image-link"
import * as TopProductHeader from "~/sections/header-edit/top-product"
import * as VideoSlider from "~/sections/video-slider"
import * as VideoSliderContent from "~/sections/video-slider/slider-content"
import * as CollectionSlider from "~/sections/collections-slider"
import * as GridImages from "~/sections/grid-images"
import * as GridImagesCentral from "~/sections/grid-images/imageCentral"
import * as GridImagesSlide from "~/sections/grid-images/imagesSlide"
import * as RegisterColor from "~/sections/header-edit/registerColors"
import * as ColorElm from "~/sections/header-edit/color"
