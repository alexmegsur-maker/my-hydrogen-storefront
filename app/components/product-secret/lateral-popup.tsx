...
function LateralPopup(props:lateralPopupProps){
  ...
  const {active, widthSize, setActive, children}=props
        ...
        <div className="flex flex-col h-full">
            ...
            <div className="sticky top-0 z-10">
              <div className="bg-black  flex text-white relative">
                ...
                >
                  ...
                  <div className="flex-none font-bold flex-1 font-['Soleil'] me-[30px] flex items-center">
                    Variante
                  </div>
                </div>
          ...
          <div className="flex-none e2e-section-variant-info">
              ...
              <div className="items-end flex p-4 border-l-0 border-t border-r-0 border-b-0 border-solid bg-[#F2F2F2] border-sl-color-greyscale-500">
                <div className="flex-1">
                  ...
                  <div className="flex items-center">
                    <div className="subheading-1 font-bold me-2 flex-wrap">
                      Rathalos
                    </div>
                  </div>
                ...
                <div className="flex-none items-end justify-end">
                  <div className="subheading-2 text-right flex-row flex gap-2">
                    <span className="text-[#A72A2F] font-bold">
                      Desde 624 €
                    </span>
                  </div>
                </div>
            ...
            <div className="px-4 pb-4 bg-[#F2F2F2]">
              <button
                onClick={closePopup}
                className="flex gap-2 items-center justify-center text-center p-5 uppercase text-white text-cta-small font-bold w-full border-none e2e-button-confirm-selection sticky bottom-0 z-10 cursor-pointer colour-buttons-primary-default hover:colour-buttons-primary-hover rounded e2e-button-confirm-selection"
              >
                Confirmar selección
              </button>
            </div>
