    ...
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content
          ...
          className={cn([
            "fixed inset-0 z-15 h-screen bg-(--color-header-bg) text-(--color-header-text) pt-4 pb-2",
        ...
        >
          <Dialog.Title asChild>
            <div className="px-4">
              <Logo className="flex place-content-start items-center h-fit justify-content-center" /> 
            </div>
          </Dialog.Title>
