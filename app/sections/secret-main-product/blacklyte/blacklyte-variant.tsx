...
function BlacklyteVariants(props: BlacklyteVariantsProps) {
 ...
 const titleStyle= {
  ...
  if (!collectionsData || collectionsData.length === 0) {
    return <div className="p-10 text-center">No se encontraron productos en las colecciones seleccionadas.</div>;
  }
  return (
    <div 
      style={{
        ...
        <div className=" flex gap-2">
          {collectionsData?.map((col, index) => {
              ...
              return (
                ...
                >
                  <span className="pointer-events-none">{col.title.split(" ")[0] +" "+ col.title.split(" ")[1]}</span>
                </div>
              );
            })}
        </div> 
