  ...
  return (
    <>
      ...
      <div 
        ...
        style={{
          position:props.stickyButton ? "sticky":"static",
          bottom:props.stickyButton ? "0":"unset",
          padding:props.stickyButton ? "1rem":"0",
                  ...
                  >
                    {(fetcher:FetcherWithComponents<any>)=>(
                      <>
                        {props.showBar &&
                          <ReservaBar 
                            productHandle={currentProd?.handle} 
                            estilos={{ 
                              barColor1:props.barColor1,
                              barColor2:props.barColor2,
                              barFamily:props.barFamily,
                              barTSize:props.barTSize,
                              barTColor:props.barTColor,
                              barTWeight:props.barTWeight,
                              barPsize:props.barPsize,
                              barPColor:props.barPColor,
                              barPWeight:props.barPWeight,
                              barFsize:props.barFsize,
                              barFColor:props.barFColor,
                              barFWeight:props.barFWeight,      
                            }}
                          />
                        }
                        ...
                        <button
                          ...
                          style={{
                            ...
                            borderColor: !hoverBuy ? props.resBgColor : props.reshBgColor,
                            background: !hoverBuy ? props.resBgColor : props.reshBgColor,
                        ...
                        >
                          {fetcher.state !== 'idle' ? 'Cargando...' : 'Reservar'}
                        </button>
                      </>
                    )}
                  </CartForm>
    ...
    },
    {
      ...
      inputs:[
        ...
        },
        {
          ...
          name:'barColor1',
          defaultValue:'#f4a72c',
          condition:(data)=>data.showBar == true
        },
        {
          type:'color',
          label:'bar color 2',
