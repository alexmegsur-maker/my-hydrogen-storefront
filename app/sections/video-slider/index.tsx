    ...
    <>
      ...
      <div className="relative w-full bg-slate-300">
        ...
        >
                  ...
                  <div className="h-[75dvh] min-h-[700px] lg:h-[80dvh] lg:min-h-auto w-full transition-[transform] duration-500 ease-in-out ">
                    <div className="h-full w-full">
                      <video
                        ...
                        muted
                        loop
                        poster={element.poster?.url}
                      >
                        <source src={element.video.url} type="video/mp4" />
                      </video>
                      <Image
                        src={element.imagen.url}
                        width=""
                        height=""
                        sizes="auto"
          ...
          <div
            ref={prevVideo}
            className="hidden lg:block absolute origin-right left-0 top-0 h-full w-full z-[5]  transition-discrete duration-500 ease-in-out -translate-x-full"
          >
            <div className="h-full w-full">
              <video
                ref={prevMedia}
                ...
                preload="none"
                muted
                poster={prevElm?.poster.url}
              >
                <source src={prevElm?.video.url} type="video/mp4" />
              </video>
              <Image
                src={prevElm?.imagen.url}
                width=""
                height=""
                sizes="auto"
          ...
          <div
            ...
            onMouseEnter={() => {
              if (active == false) {
                ...
                prevVideo.current.style.animation =
                  "showPartialVideoLeft 500ms ease forwards";
                setActive(true);
              }
            }}
            onClick={() => {
              ...
              void prevVideo.current.offsetWidth;
              prevVideo.current.style.animation =
                "showPartialVideoLeft 100ms ease reverse forwards";
              setActive(false);
            }}
            onMouseLeave={() => {
              if (active) {
                ...
                void prevVideo.current.offsetWidth;
                prevVideo.current.style.animation =
                  "showPartialVideoLeft 500ms ease reverse forwards";
                setActive(false);
              }
            }}
            className="group slideshow-arrow-prev border-0 bg-transparent absolute top-0 left-0 h-full pl-4 lg:pl-16 z-10 flex items-center  lg:w-[200px] cursor-pointer"
            data-context="splash-arrow"
          >
          ...
          >
            <div className="h-full w-full">
              <video
                ...
                preload="none"
                muted
                poster={nextElm?.poster.url}
              >
                <source src={nextElm?.video.url} type="video/mp4" />
              </video>
              <Image
                sizes="auto"
                src={nextElm?.imagen.url}
                width=""
                height=""
                className="object-cover w-full h-full lg:hidden"
              />
          ...
          <div
            ...
            onMouseEnter={() => {
              if (active == false) {
                ...
                nextVideo.current.style.animation =
                  "showPartialVideoRight 500ms ease forwards";
                setActive(true);
              }
            }}
            onClick={() => {
              ...
              void nextVideo.current.offsetWidth;
              nextVideo.current.style.animation =
                "showPartialVideoRight 100ms ease reverse forwards";
              setActive(false);
            }}
            onMouseLeave={() => {
              if (active) {
                ...
                void nextVideo.current.offsetWidth;
                nextVideo.current.style.animation =
                  "showPartialVideoRight 500ms ease reverse forwards";
                setActive(false);
              }
            }}
            className="group slideshow-arrow-next border-0 bg-transparent absolute top-0 right-0 h-full pr-4 lg:pr-16 z-10 flex items-center justify-end lg:w-[200px] cursor-pointer"
            data-context="splash-arrow"
          >
            <button className=" box-border flex gap-2 items-center justify-center w-fit rounded-full cursor-pointer  p-1 border-solid border-[1px] border-transparent st-colour-buttons-inverse-default hover:st-colour-buttons-inverse-hover hover:fill-white fill-none ">
              <div className="border-rounded-full flex items-center justify-content w-[16px] h-[16px] group-hover:fill-white duration-500">
          ...
          <div className="absolute bottom-0 left-0 w-full pt-4 pb-[70px] lg:pb-[116px] z-20 flex">
            <div className="absolute top-0 left-0 h-full w-full bg-gradient-to-t from-black to-transparent transition-opacity opacity-[0.8] z-0"></div>
              ...
              {sliderElements[currentElm]?.tag && (
                <span
                  ...
                  style={{
                    ...
                    fontSize: !isMobile
                      ? sliderElements[currentElm].tgSize
                      : "18px",
              ...
              {sliderElements[currentElm]?.title && (
                <h2
                  ...
                  style={{
                    ...
                    fontSize: !isMobile
                      ? sliderElements[currentElm].tSize
                      : "30px",
              ...
              {sliderElements[currentElm]?.description && (
                <p
                  ...
                  style={{
                    ...
                    fontSize: !isMobile
                      ? sliderElements[currentElm].dSize
                      : "18px",
                ...
                {sliderElements[currentElm]?.button && (
                  <Link
                    ...
                    style={{
                      ...
                      fontSize: !isMobile
                        ? sliderElements[currentElm].bSize
                        : "14px",
                    ...
                    sliderElements.map((element, index) => {
                      return (
                        <button
                          ...
                          key={element.id}
                          className="dot bg-transparent border-0 basis-full flex flex-col justify-center gap-2 py-6 lg:py-0 px-0"
                          data-context="splash-paginationbar"
                        >
                          <span
                            data-context="splash-paginationbar"
