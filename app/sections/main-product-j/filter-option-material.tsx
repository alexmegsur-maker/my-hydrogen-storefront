...
interface FilterOptionMaterialProps extends HydrogenComponentProps {
  title: string;
...
export default function FilterOptionMaterial(props: FilterOptionMaterialProps) {
  const {
    title,
    paddingSelect,
    paddingText,
  ...
  useEffect(() => {
    setSelected(currentProduct?.material)
  }, [currentProduct]);

  const changeVariant = (elm: string) => {
          ...
          {variantSelected.options?.map((opt, index) => {
            ...
            return (
              <div
                ...
                onClick={() =>
                  changeVariant(product.value.toLowerCase())
                }
      ...
      >
        ...
        >
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: renderRichText(
                variantSelected.guia?.find((e) => e.key === "description")?.value
              ),
            }}
          ></div>
          ...
          <div
            ...
            dangerouslySetInnerHTML={{
              __html: renderRichText(
                variantSelected.guia?.find((e) => e.key === "frecuency_content")?.value
              ),
            }}
            style={{
              fontSize: lcFSize,
...
export const schema = createSchema({
  title: "Filter Option - Material",
  type: "filter-option-material",
   settings: [
    {
      group: "General",
      inputs: [
