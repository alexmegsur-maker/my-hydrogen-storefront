...
export type ChairSectionQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
}>;

export type ChairSectionQuery = {
...
export type CollectionsByIdslistQueryVariables = StorefrontAPI.Exact<{
  ids:
    | Array<StorefrontAPI.Scalars['ID']['input']>
    | StorefrontAPI.Scalars['ID']['input'];
}>;

export type CollectionsByIdslistQuery = {
  nodes: Array<
    StorefrontAPI.Maybe<
      Pick<
          ...
          edges: Array<{
            ...
            > & {
              ...
              featuredImage?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Image, 'altText' | 'url'>
              >;
              logoMetafield?: StorefrontAPI.Maybe<
              ...
              >;
              imagenes360?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Metafield, 'key' | 'value'> & {
                  references?: StorefrontAPI.Maybe<{
                    nodes: Array<{
                      previewImage?: StorefrontAPI.Maybe<
              ...
              >;
              videosMetafield?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Metafield, 'id' | 'type'> & {
                  references?: StorefrontAPI.Maybe<{
                    nodes: Array<
                      Pick<StorefrontAPI.Video, 'id' | 'alt'> & {
              ...
              >;
              pageMetafield?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Metafield, 'id' | 'type' | 'value'> & {
                  reference?: StorefrontAPI.Maybe<
                    Pick<
                      StorefrontAPI.Page,
                      'id' | 'title' | 'body' | 'onlineStoreUrl'
                    >
                  >;
                }
              >;
              ...
              material?: StorefrontAPI.Maybe<
                Pick<StorefrontAPI.Metafield, 'key' | 'type' | 'value'>
              >;
              variants: {
                edges: Array<{
                  node: Pick<
...
> & {
  ...
  nombre?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'id' | 'value'>>;
  principalImg?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Metafield, 'key' | 'value'> & {
      reference?: StorefrontAPI.Maybe<{
        previewImage?: StorefrontAPI.Maybe<
  ...
  >;
  tooltip?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'id' | 'value'>>;
  options: Array<
  ...
  product?: StorefrontAPI.Maybe<
    ...
    > & {summary: StorefrontAPI.Product['description']} & {
      ...
      pageMetafield?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'type' | 'value'> & {
          reference?: StorefrontAPI.Maybe<
            Pick<StorefrontAPI.Page, 'id' | 'title' | 'body' | 'onlineStoreUrl'>
          >;
        }
      >;
      especificaciones?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'>
      >;
      fechaReserva?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'>
      ...
      modelo?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'>
      >;
      modelTag?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'>
      >;
      modelDescription?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'>
      >;
      miniDescription?: StorefrontAPI.Maybe<
        Pick<StorefrontAPI.Metafield, 'id' | 'value'>
      >;
      variants: {
        nodes: Array<
          ...
          > & {
            ...
            tooltip?: StorefrontAPI.Maybe<
              Pick<StorefrontAPI.Metafield, 'id' | 'value'>
            >;
            especification?: StorefrontAPI.Maybe<
              Pick<StorefrontAPI.Metafield, 'id' | 'value'>
            >;
            fechaReserva?: StorefrontAPI.Maybe<
              Pick<StorefrontAPI.Metafield, 'id' | 'value'>
...
export type MediaImagesByIdsQuery = {
  nodes: Array<
    StorefrontAPI.Maybe<
...
export type MediaImagesByIdQueryVariables = StorefrontAPI.Exact<{
  id: StorefrontAPI.Scalars['ID']['input'];
}>;

export type MediaImagesByIdQuery = {
...
export type PageByIdQueryVariables = StorefrontAPI.Exact<{
  id: StorefrontAPI.Scalars['ID']['input'];
}>;
...
export type GoogleShoppingFeedQueryVariables = StorefrontAPI.Exact<{
  first: StorefrontAPI.Scalars['Int']['input'];
  cursor?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['String']['input']>;
}>;

export type GoogleShoppingFeedQuery = {
  products: {
...
export type SitemapCatalogQueryVariables = StorefrontAPI.Exact<{
  [key: string]: never;
}>;

export type SitemapCatalogQuery = {
...
export type LiveActivityQueryVariables = StorefrontAPI.Exact<{
  first: StorefrontAPI.Scalars['Int']['input'];
}>;

export type LiveActivityQuery = {
  metaobjects: {
    nodes: Array<
      Pick<StorefrontAPI.Metaobject, 'id'> & {
...
export type SearchPageQueryVariables = StorefrontAPI.Exact<{
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  endCursor?: StorefrontAPI.InputMaybe<
    StorefrontAPI.Scalars['String']['input']
  >;
...
export type SearchPageQuery = {
  ...
  articles: {
    nodes: Array<
      Pick<
        StorefrontAPI.Article,
        'id' | 'title' | 'handle' | 'publishedAt' | 'excerpt' | 'contentHtml'
      > & {
        image?: StorefrontAPI.Maybe<
          Pick<StorefrontAPI.Image, 'url' | 'altText' | 'width' | 'height'>
        >;
  ...
  pages: {
    nodes: Array<Pick<StorefrontAPI.Page, 'id' | 'title' | 'handle' | 'body'>>;
  };
  collections: {
    nodes: Array<
...
export type OptionMetaobjectsQueryVariables = StorefrontAPI.Exact<{
  first?: StorefrontAPI.InputMaybe<StorefrontAPI.Scalars['Int']['input']>;
}>;

export type OptionMetaobjectsQuery = {
  metaobjects: {
    edges: Array<{
...
interface GeneratedQueryTypes {
  ...
  '#graphql\n  query ChairSection($handle: String!) {\n    metaobject(handle: { handle: $handle, type: "scroll_chair" }) {\n      handle\n      fields {\n        key\n        value\n        reference {\n          ... on MediaImage {\n            image {\n              url\n              altText\n              width\n              height\n            }\n          }\n        }\n        references(first: 50) {\n          nodes {\n            ... on MediaImage {\n              image {\n                url\n                altText\n                width\n                height\n              }\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: ChairSectionQuery;
    variables: ChairSectionQueryVariables;
  };
  ...
  '#graphql\n  query MediaImagesByIds($ids:[ID!]!){\n    nodes(ids:$ids){\n      ... on MediaImage{\n        id\n        mediaContentType\n        image{\n          url\n          altText\n          width\n          height\n        }\n        previewImage{\n          url\n          altText\n        }\n      }\n    }\n  }\n': {
    return: MediaImagesByIdsQuery;
    variables: MediaImagesByIdsQueryVariables;
  };
  '#graphql\n  query MediaImagesById($id:ID!){\n    node(id:$id){\n      ... on MediaImage{\n        id\n        mediaContentType\n        image{\n          url\n          altText\n          width\n          height\n        }\n        previewImage{\n          url\n          altText\n        }\n      }\n    }\n  }\n': {
    return: MediaImagesByIdQuery;
    variables: MediaImagesByIdQueryVariables;
  };
  ...
  '#graphql\n  query GoogleShoppingFeed($first: Int!, $cursor: String) {\n    products(first: $first, after: $cursor, query: "status:active") {\n      pageInfo {\n        hasNextPage\n        endCursor\n      }\n      nodes {\n        id\n        title\n        handle\n        vendor\n        description\n        featuredImage {\n          url\n        }\n        images(first: 10) {\n          nodes {\n            url\n          }\n        }\n        variants(first: 100) {\n          nodes {\n            id\n            title\n            sku\n            barcode\n            availableForSale\n            price {\n              amount\n              currencyCode\n            }\n            compareAtPrice {\n              amount\n              currencyCode\n            }\n            image {\n              url\n            }\n            selectedOptions {\n              name\n              value\n            }\n          }\n        }\n      }\n    }\n  }\n': {
    return: GoogleShoppingFeedQuery;
    variables: GoogleShoppingFeedQueryVariables;
  };
  ...
  '#graphql\n  query OptionMetaobjects($first: Int = 50) {\n    metaobjects(type: "option", first: $first) {\n      edges {\n        node {\n          handle\n          fields {\n            key\n            value\n          }\n        }\n      }\n    }\n  }\n': {
    return: OptionMetaobjectsQuery;
    variables: OptionMetaobjectsQueryVariables;
  };
